...
public class TransactionManager implements TransactionManagerInterface,Serializable {
	...
	public javax.sql.RowSet fetchDetachedRowSet_No_release() throws Exception {
		...
		try {
			...
			//LOGGER.error(ex);
			throw new Exception("Error in fetching details");
		}
		return rowSet;
	}
