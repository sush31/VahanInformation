 ...
 * @author RCN
 */
public class MasterTableDO implements Serializable{

	//private static final Logger logger = Logger.getLogger(MasterTableDO.class);
	////////////////////////////////////////////////////////////////////////
	// CONSTANTS
	////////////////////////////////////////////////////////////////////////
	/**
	 ...
	 *            Table name
	 * @param metadata
	 *            Gives the column name and column data type
	 * @param data
	 *            Data as it is in the master table
	 * @param data_AO
	 *            Data that is available and is ordered as per the user.
	 *            *Available Order* is done using the VSM_CHOICE_ORDER
	 */
	public MasterTableDO(String tableName, String[][] metadata, String[][] data, String[][] data_AO) {
	...
	public MasterTableDO(String tableName, String[][] metadata, String[][] data, String[][] data_AO, Map datamap,
	...
	public MasterTableDO(String tableName, String[][] metadata, String[][] data, String[][] data_AO, Map datamap,
			String code, String descr, String tablelabel) {
	...
	public String getDesc(String code) throws Exception {
		...
		// Debug.log(msg);
		String msg = "DEV_ERROR : Ouch! Unknown code = " + code + " passed to MasterTablesDO.getDesc() for table : "
				+ this.tableName;
	 ...
	 *
	 * @param desc
	 *            Given description in String.
	 *
	 * @return Associated code.
	 *
	 * @throws VahanException
	 *             In case of unknown description
	 */
	public String getCode(String desc) throws Exception {
		...
		// As the control reaches here, something is wrong.
		// Throw an exception.
		// String msg = Debug.BUG +"DEV_ERROR : Ouch! Unknown description = "
		// +desc
		// +" passed to MasterTablesDO.getCode()";
		// Debug.log(msg);
		String msg = "DEV_ERROR : Ouch! Unknown description = " + desc
				+ " passed to MasterTablesDO.getCode() for table : " + this.tableName;
		//logger.info("" + msg);
		throw new Exception(msg);
	}
	 ...
	 *
	 * @param colIdx
	 *            Column index for which the data need to be returned.
	 *
	 * @return the data
	 */
	protected static String[] getDataForColumn(int colIdx, String[][] tableData) throws Exception {
