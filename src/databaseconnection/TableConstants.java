...
public interface TableConstants {
	...
	int VM_TAX_INSTALLMENT=355;
	int VM_TAX_EXEMPTION=125;
	int VM_TAX_CLEARANCE=345;
	int VM_RETENTION_OF_REGN_NO=331;
	int VM_NONUSE_RESTORE_REMOVE=367;
	int VM_REASSIGNMENT_BH_SERIES=117;
	int VM_REASSIGNMENT_BH_TO_RUNNING=128;
	int VM_REASSIGNMENT_VINTAGE_VEHNO=139;
	int VM_RETENTION_SCRAPPED_VEHICLE=140;
	int VM_SCRAPPED_VEHICLE=349;
	int VM_RETENTION_REGN_MARK=10;
	int VM_RC_PARTICULARS_INDIVIDUAL=174;
	int VM_RC_PARTICULARS_COMPANY=173;
