...
public class CitizenServiceFlowDobj {

	private int flow_srno;
	...
	public void setFlow_srno(int flow_srno) {
		this.flow_srno = flow_srno;
	}
	...
	public boolean isMove_to_vahan4() {
		return move_to_vahan4;
	}
	public void setMove_to_vahan4(boolean move_to_vahan4) {
		this.move_to_vahan4 = move_to_vahan4;
	}
